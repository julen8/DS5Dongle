...
/* 运行时改速率比 (不清状态) */
void lerp_rs_48to3_set_rates(lerp_rs_48to3_t *rs, uint32_t in_rate_hz, uint32_t out_rate_hz);
...
int lerp_rs_48to3_process(lerp_rs_48to3_t *rs, const int16_t *in, int nin, int8_t *out, int nout_max);
